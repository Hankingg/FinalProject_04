...
CREATE TABLE MEM_TYPE
    (
    MT_ID VARCHAR2(20) PRIMARY KEY
    , MT_NAME VARCHAR2(20) CONSTRAINT MT_NAME_NN NOT NULL
    );

COMMENT ON COLUMN MEM_TYPE.MT_ID IS '회원유형ID';
...
CREATE TABLE MEMBER 
    ...
    , MT_ID VARCHAR2(20) CONSTRAINT MT_ID_NN NOT NULL CONSTRAINT MT_ID_FK REFERENCES MEM_TYPE(MT_ID)
    ...
    , PHONE VARCHAR2(13)
    , MEMBERSHIP CHAR(1) DEFAULT 'N' CONSTRAINT MEMBERSHIP_CK CHECK(MEMBERSHIP IN('Y', 'N')) NOT NULL
...
CREATE SEQUENCE SEQ_MTID NOCACHE;
CREATE SEQUENCE SEQ_ALERTNO NOCACHE;
CREATE SEQUENCE SEQ_HCTG NOCACHE;
CREATE SEQUENCE SEQ_IMGFILE NOCACHE;
