              ...
              <div id="topBtn">
                <a href="#">
                  <!-- <svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    viewBox="0 0 32 32" fill="rgb(230, 126, 34)" data-svg-content="true">
                      <g>
                        <path
                  ...
                  <img id="topBtnImg" src="resources/mainIcon/top2.png">
                </a>
              </div>
              <script>
                // 버튼을 클릭했을 때 화면을 맨 위로 스크롤하는 함수를 정의합니다.
                $("#topBtn").addEventListener("click", function() {
                    // smooth scroll 기능을 사용하여 부드럽게 스크롤합니다.
                    window.scrollTo({
                      top: 0, // 화면의 맨 위로 이동합니다.
