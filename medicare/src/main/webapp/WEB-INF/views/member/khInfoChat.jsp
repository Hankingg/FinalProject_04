...
<head>
    <meta charset="UTF-8">
    <title>채팅 페이지</title>
    <link rel="stylesheet" href="https://gcore.jsdelivr.net/npm/bootstrap@4.6.2/dist/css/bootstrap.min.css">
...
<body>
    ...
    <!-- jQuery 추가 -->
    <script src="https://gcore.jsdelivr.net/npm/jquery@3.7.1/dist/jquery.slim.min.js"></script>
    <script>
       var serverUrl = "ws://192.168.20.28:8008/medicare/KhInfoChat";
