...
<jsp:include page="../common/header.jsp"/>
	<div class="main-panel">
		...
		<div id="selectMember">
			<h2 style="color:gray;" id="admin_title">관리자 회원관리</h4>
			<br><br>
			 <table id="deleteTable" style="border:1px solid gray;">
					...
					<tbody style="border:1px solid gray;">
						<form id="deleteForm" action="adminDeleteMember.me" method="post" onsubmit="return confirmDelete()">
							<c:forEach var="am" items="${ adminSelectMem }"> 								
								<tr>									
		                            <th><input type="checkbox" value="${ am.memNo }" name="deleteMember"></th>
					  ...
					  <button type="submit" id="deleteBtn" onclick="deleteConfirm()">회원삭제</button>					  
					  <button type="submit" id="restoreBtn"><a href="adminRestore.me">회원복구 페이지 이동</a></button>
                    </tbody>
