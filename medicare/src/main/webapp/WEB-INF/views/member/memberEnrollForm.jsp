          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form action="insert.me" method="post" class="pt-3">
                ...
                <div class="form-group">
                  <input type="text" class="form-control form-control-lg" id="memName" name="memName" placeholder="이름" requiredrequired>
                </div>
                 <div class="form-group">
                ...
                <div class="mt-3">
                 <button class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn"> 가입하기</button>  
                </div>
